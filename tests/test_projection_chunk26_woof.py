...
def package_fixture() -> dict:
    objects = [
        {
            "id": "natal:Mars", "name": "Mars", "object_type": "planet_or_point",
            "sign": "Leo", "house": 6, "structural_strength_score": 0.8,
        },
        {
            "id": "natal:Venus", "name": "Venus", "object_type": "planet_or_point",
            "sign": "Scorpio", "house": 8, "structural_strength_score": 0.9,
        },
        {
            "id": "natal:Mercury", "name": "Mercury", "object_type": "planet_or_point",
            "sign": "Gemini", "house": 3, "structural_strength_score": 0.86,
        },
        {
            "id": "natal:ASC", "name": "ASC", "object_type": "angle",
            "sign": "Aquarius", "house": 1, "structural_strength_score": 0.95,
        },
        {
            "id": "house:8", "name": "House 8", "object_type": "house_cusp",
            "facts": {"house": 8}, "structural_strength_score": 0.7,
        },
    ]
    aspect_names = [
...
def test_woofmapped_all_sdk_aspects_and_projection_first_reasoning():
    ...
    aspect_types = {
        row["attributes"]["canonical_aspect"]: row["relationship_type"]
