...
def test_projection_emits_one_arc_and_preserves_temporal_facts():
...
def test_activation_projection_is_deterministic_and_input_immutable():
    req = request()
...
def test_activation_projection_classifies_mean_node_as_policy_excluded():
    req = request()
