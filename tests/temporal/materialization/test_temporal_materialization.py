...
def test_materializations_preserve_semantic_payload():
    full = _full()
...
def test_state_availability_and_audit_reconciliation():
    full = _full()
...
def test_target_resolution_categories_are_present():
    full = _full()
